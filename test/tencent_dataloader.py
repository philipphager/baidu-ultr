"""
Data loading from the Tencent submission to the Baidu WSDM 23 cup:
https://github.com/lixsh6/Tencent_wsdm_cup2023/blob/main/pytorch_unbias/pretrain/dataset.py
"""
import collections
import gzip
import logging
